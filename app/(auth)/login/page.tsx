  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader className="space-y-1">
        ...
        <CardDescription className="text-center">Sign in to your FlowGuard account</CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <p className="text-sm text-center text-gray-600">
            ...
            <Link href="/register" className="text-primary-green hover:underline font-medium">
              Sign up
            </Link>
          </p>
        </form>
